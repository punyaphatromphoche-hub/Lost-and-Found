    ...
    <footer className="bg-slate-900 text-slate-300 mt-auto border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-3">
              ...
              <span className="font-bold text-lg text-white">BJS3 Lost & Found</span>
            </div>
            <p className="text-sm text-slate-400 leading-relaxed">
              ระบบศูนย์กลางแจ้งของหายและส่งคืนของที่พบ สำหรับนักเรียน ครู และบุคลากร โรงเรียนบรรหารแจ่มใสวิทยา 3
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/lost" className="hover:text-amber-400 transition-colors">
                  รายการของที่หาย (Lost Items)
                </Link>
              </li>
              <li>
                <Link href="/found" className="hover:text-amber-400 transition-colors">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              โรงเรียนบรรหารแจ่มใสวิทยา 3<br />
        ...
        <div className="mt-8 pt-6 border-t border-slate-800 text-center text-xs text-slate-500">
          <p>© {new Date().getFullYear()} BJS3 Lost & Found. โรงเรียนบรรหารแจ่มใสวิทยา 3. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
